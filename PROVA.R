...
C:\Users\Alunos\AppData\Local\Temp\RtmpAfEOFB\downloaded_packages
> install.packages("aTSA", dependencies = T)
Installing package into 'C:/Users/Alunos/Documents/R/win-library/3.5'
(as 'lib' is unspecified)
...
> library("urca")
> library(readxl)
> X0x <- read_excel("C:/Econometria/0x.xlsx", 
                    +     col_types = c("date", "numeric"))
> View(X0x)
> X0xts <-  ts(log(X0x$Close), start = 2017, frequency = 365)
> plot(Xoxts, type="l", main="Logaritmos do Preço do Bitcoin", ylab="Log Preço", xlab="Data", col="Blue"))
Error: unexpected ')' in "plot(Xoxts, type="l", main="Logaritmos do Preço do Bitcoin", ylab="Log Preço", xlab="Data", col="Blue"))"
> plot(X0xts, type="l", main="Logaritmos do Preço do Bitcoin", ylab="Log Preço", xlab="Data", col="Blue")
> grid(col = "black", lty = "dotted")
> 
  > acf(log(X0x$Close),lend=2, lwd=5,col="darkblue",main= "Função Autocorrelação - FAC")  
> axis(1,tck = 1, col = "lightgrey", lty = "dotted")
> pacf(log(X0x$Close),lend=60, lwd=5,col="darkblue",main= "Função Autocorrelação - FAC")
> axis(1,tck = 1, col = "lightgrey", lty = "dotted")
